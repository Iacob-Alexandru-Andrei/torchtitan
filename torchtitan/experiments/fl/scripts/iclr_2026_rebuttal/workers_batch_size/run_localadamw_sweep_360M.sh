...
CONFIG_FILE=${CONFIG_FILE:-"${SCRIPT_DIR}/base_local_sgd_360M.toml"}
TRAIN_MODULE=${TRAIN_MODULE:-"torchtitan.experiments.fl.train"}
MODEL_SIZES=${MODEL_SIZES:-"360M"}
WORKER_COUNTS=${WORKER_COUNTS:-"8 4 2 1"}
GLOBAL_BATCH_SIZES=${GLOBAL_BATCH_SIZES:-"64 128 256 512 1024"}
RUN_PREFIX=${RUN_PREFIX:-"iclr2026-localadamWB"}
LOG_RANK=${LOG_RANK:-0}
LOCAL_BATCH_SIZE_CAP=${LOCAL_BATCH_SIZE_CAP:-${LOCAL_BATCH_SIZE:-16}}
BASE_LR=${BASE_LR:-0.04}
VS_VALUE=${VS_VALUE:-0.98}
REFERENCE_GLOBAL_BATCH_SIZE=${REFERENCE_GLOBAL_BATCH_SIZE:-64}
REFERENCE_TRAINING_STEPS=${REFERENCE_TRAINING_STEPS:-40960}
...
WARMUP_RUN_STEP_16M="warmup-125M-bs256-s2048-20251112-225419/step-2048"
...
for model_size in "${MODEL_SIZE_ARRAY[@]}"; do
  warmup_step="warmup-125M-bs256-s2048-20251112-225419/step-2048"
