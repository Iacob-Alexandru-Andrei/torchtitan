...
# Configuration
NGPU=${1:-"8"}  # Number of GPUs / replicas (default: 2)
CONFIG_FILE=${2:-"./torchtitan/experiments/fl/configs/mosaic_mup_7B_qhadamw_torchft.toml"}
...
# Lighthouse settings
MIN_REPLICAS=${MIN_REPLICAS:-8}  # Minimum replicas required to start training
...
# Log directory
LOG_DIR="${REPO_ROOT}/outputs/torchft_logs_7B"
mkdir -p "${LOG_DIR}"
