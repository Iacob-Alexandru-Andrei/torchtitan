...
class FlexAttention(torch.nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        if attn_mask_type not in ["causal", "block_causal", "sequence_id_causal"]:
    ...
    @staticmethod
    def _get_sequence_id_causal_mask_mod(
        ...
        for mask_key in FlexAttention.used_attn_mask_types:
            ...
            match attn_mask_type:
                ...
                case "sequence_id_causal":
                    ...
                    batch_dimension = batch.shape[0]
                    mask_mod = FlexAttention._get_sequence_id_causal_mask_mod(
                        sequence_id
                    )
                case _:
...
def init_attention_mask(
    ...
    FlexAttention.init_attention_mask(batch, eos_id, sequence_id)
